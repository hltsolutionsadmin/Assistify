      ...
      build: (pw.Context context) {
        return pw.Column(
          ...
          children: [
                ...
                children: [
                    ...
                    (index) => pw.TableRow(
                      children: [
                        ...
                        pw.Padding(
                          padding: pw.EdgeInsets.all(5),
                          child: pw.Text(
                            ((spares?[index].price ?? 0) * (spares?[index].quantity ?? 0)).toString(),
                          ),
                        ),
                      ],
                    ),
                  ...
                  pw.TableRow(
                    children: [
                      ...
                      pw.Padding(
                        padding: pw.EdgeInsets.all(5),
                        child: pw.Text('$grandTotal', style: pw.TextStyle(fontWeight: pw.FontWeight.bold)),
                      ),
                    ],
                  ),
                ],
              ...
              child: pw.Column(
                ...
                children: [
                  pw.Row(
                    ...
                    children: [
                      pw.Text('PAID AMOUNT:', style: pw.TextStyle(fontWeight: pw.FontWeight.bold)),
            ...
            pw.Bullet(
              text: 'The original of this work order this given to the customer as a receipt for your equipment.',
            ),
            pw.Bullet(
              text: 'The recipt should be produced at the time of collection the equipment. No deleveries can be made if this receipt is lost',
            ),
            pw.Bullet(
              text: 'Our responsibility is limit to serve of this equipment only. We are not responsible for consequential damages arising from delay in non repairs of the equipment.',
            ),
            pw.Bullet(
              text: 'Equipment should be collected from with 30 days from the date of information on product of this receipt.',
            ),
            pw.Bullet(
              text: 'Company assumes no responsibility whatever if this equipment not collected within 30 days from the date of',
            ),
